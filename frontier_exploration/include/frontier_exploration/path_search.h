...
namespace frontier_exploration{
    ...
    public:
        ...
        path_search(Eigen::VectorXd uav_plan_pos,Eigen::VectorXd ugv_plan_pos, frontier_exploration::AirGroundSimExploreLayer* service,
                    ...
                    double wy_max_param, double rho_param, double ground_range, double plan_time_start);
        bool find_max_path(root_node* tree, Eigen::MatrixXd &coef, std::list<FrontierCell> &node_list, Eigen::Vector3d acc);
        bool collision_free(search_tree* max_node, Eigen::Vector3d acc);
